...
<body>
			...
			<div class="content">
				<div class="signin-cont cont">
					<form id = "loginForm" enctype="multipart/form-data">
						<input type="text" name="userId" id="userLoginId" class="inpt" required="required" placeholder="Your name"> 		
						 <label for="text">Your ID</label> 
						 <input type="password" name="userPw" id="userLoginPw" class="inpt" required="required" placeholder="Your password"> 
						 <label for="password">Your password</label>
				
						<div class="submit-wrap">
							<input type="button" id="loginBtn" value="Sign in" class="submit">
						</div>
					</form>
				</div>
				...
				<div class="signup-cont cont">
					<form id = "joinForm" enctype="multipart/form-data">
						<input type="text" name="userId" id="userJoinId" class="inpt" required="required" placeholder="ID(영문 6~20자 )"> 
					
							<input type="password" name="userPw" id="userJoinPw" class="inpt" required="required" placeholder="PW"> 
						
							<input type="password" name="checkPw" id="checkPw" class="inpt" required="required" placeholder="Check password">				
						<div class="submit-wrap">
							<input type="button" id="joinBtn" value="Sign up" class="submit">	
						</div>
					</form>
				</div>
			</div>
	...
	<script src= "${path}/js/member/login.js">
